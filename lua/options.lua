...
-- opt.numberwidth = 4 -- default is 4, so this is pointless
-- opt.relativenumber= true
opt.termguicolors = true
opt.scrolloff = 10 -- Lines of context
opt.clipboard = "unnamedplus"
opt.showmode = false -- turns off the mode display on the command line
...
-- Reference/Examples: - Pull these in as you need them
-- local opt = vim.opt -- to set options
